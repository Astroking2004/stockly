...
async def app(ticker: str, period: str = "1mo"):
    ...
    return recommendation, img_path


gui = gr.Interface(
    fn=app,
    inputs=[gr.Textbox(label="Ticker (e.g. AAPL, BTC-USD)"), gr.Textbox(label="Period", value="1mo")],
    outputs=[gr.Textbox(label="Recommendation"), gr.Image(label="Trend")],
    title="Stockly: Price Trends & Recommendations",
    description="Enter a stock or crypto ticker to get price trends and AI-powered recommendations.",
